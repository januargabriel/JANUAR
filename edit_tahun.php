              ...
              <form class="form-horizontal">
                <div class="card-body">
                   <div class="form-group row" style="margin-left: 10px";>
                    <label for=" Kode Guru " class="col-sm-2 col-form-label" >Kode Guru</label>
                     <div class="col-sm-4">
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="01KJGLIKHFYDF" name="username">
                     <!--  <select >Guru Pengganti
