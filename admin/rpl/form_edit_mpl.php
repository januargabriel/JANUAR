        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/Admin/edit_mpl/" .$id;?>" enctype="multipart/form-data">
                ...
                <div class="satu col-sm-12">
                  ...
                  <div class="form-group row";>
                    <label for="tahun" class="col-sm-4 col-form-label">Nama Mapel</label>
                    <div class="col-sm-8">
