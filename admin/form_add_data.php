        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_thn" enctype="multipart/form-data">
                <div class="card-body row">
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Kode</label>
                    <div class="col-sm-8">
                      <input type="text" name="kode_thn" value="<?php echo $kodeunik ?>" style="color:red" class="form-control" required='required' disabled="disable">
                      <input type="hidden" name="kode_thn" value="<?php echo $kodeunik ?>">
                    </div>
                  </div>  
                  
                  <div class="form-group row";>
                    <label for="input" class="col-sm-4 col-form-label">TAHUN AJARAN</label>
                    <div class="col-sm-8">
                     <select name="thn_ajaran" class="form-control">
                        <option value="2023/2024">1</option>
                        <option value="2024/2025">2</option>
                        <option value="2025/2026">3</option>
                      </select>
                    </div>
                  </div>
                   <!-- <div class="form-group row";>
...
<!-- Bootstrap 4 -->
<script src="<?= 'http://file.smkbatikpwrj.sch.id/assets/dist/js/adminlte.min.js'?>/plugins/bootstrap/js/bootstrap.bundle.min.js'?>"></script>
<!-- AdminLTE App -->
