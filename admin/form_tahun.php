  ...
  <div class="content-wrapper" style="background-color: LightSteelBlue">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: Times New Roman;text-align: center; color: black; padding-left: 120px">Manajemen Tahun Ajaran</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
            ...
            <div class="card" style="background-color: powderblue">
              <div class="card-header" style="background-color: SkyBlue">
                <a href="<?php echo site_url('Admin/add_thn');?>"><span class="btn btn-primary">
                <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah</span></a>
                <a href="http://localhost/pkl/index.php/Admin/add_mapel"><span class="btn btn-secondary">
                <i class="fa fa-file" aria-hidden="true"></i></span></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style="background-color: lightblue">
                <table id="example1" class="table table-bordered table-striped">
                  <thead style="text-align: center;background-color:blue;color: white;  skyblue">
                  <tr>
                  ...
                  <tbody style="background-color: DarkTurquoise">
                    <?php
                    $no=1;
                    ...
                    <td><?php  echo $no++; ?></td>
                    <td><?php  echo $row->kode_thn;?></td>
                    <td><?php  echo $row->thn_ajaran;?></td>
                    <td><?php  echo $row->keterangan == 1 ? 'Aktif' : 'Tidak Aktif';?></td>
                    <td style="background-color: DarkTurquoise;" >
                      <a href="<?php echo base_url() ?>index.php/Admin/edit_thn/<?php echo $row->Id_thn ?>"><span class="btn btn-primary" style="margin-left: 10px">&nbsp;Edit</span></a>
                       <a href="<?php echo base_url() ?>index.php/Admin/delete_thn/<?php echo $row->Id_thn?>"><span class="btn btn-danger" style="color : white; margin-left: 10 px">Hapus</span></a>
                       <form class="d-inline" method="post" action="<?php echo site_url('Admin/aktifkanthn');?>">
                       <input class="d-none" type="text" name="id" value="<?=$row->Id_thn?>" >
                              <?php
                              if ($row->keterangan == 0) {
                              ?>
                              ...
                              ?>
                              <button type="submit" class="btn btn-secondary disabled btn-sm">Aktifkan</button>
                              <?php  } ?>
