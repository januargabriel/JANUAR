        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_guru" enctype="multipart/form-data"  style="background-color: skyblue">
                <div class="card-body row">
                <div class="satu col-sm-12"style="color:Lime;font-family: Times New Roman">
                  ...
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Nama Guru</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama_guru" value="<?php echo set_value('nama_guru') ?>"class="form-control" required='required'>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="username" value="<?php echo set_value('username') ?>"class="form-control" required='required'>
                  ...
                  <div class="form-group row">
                    <label for="Pelajaran" class="col-sm-4 col-form-label">Mapel</label>
                     <div class="col-sm-8">
                       <select id="mapel" name="nama_mapel" class="form-control" required='required'>
                        ...
                        $query2 = mysqli_query("SELECT * FROM mapel ORDER BY mapel.nama_mapel");
                         ...
                         foreach ($datamapel as $key => $value) {
                          ?>
                          <option id="mapel" class="<?php echo $value['Id_mapel']; ?>" value="<?php echo $value['nama_mapel']; ?>"><?php echo $value['nama_mapel']; ?>
                          </option>
                          <?php
                         }
                        ?>
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="password" value="<?php echo set_value('password') ?>" class="form-control" required='required'>
                        </div>
                      </div>
