  ...
  <div class="content-wrapper" style="background-color:  LightSteelBlue">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: Times New Roman;text-align: center;padding-left: 120px">Manajemen Mapel</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
            ...
            <div class="card" style="background-color: powderblue">
              <div class="card-header" style="background-color: skyblue">
                <a href="<?php echo site_url('Admin/add_guru');?>"><span class="btn btn-primary">
                 ...
                 <tbody>
                   ...
                   ?>
                    ...
                    <td style="background-color: DarkTurquoise; ">
                      <a href="<?php echo base_url() ?>index.php/Admin/edit_guru/<?php echo $row->Id_guru ?>"><span class="btn btn-primary" style="margin-left: 10px">&nbsp;Edit</span></a>
                       <a href="<?php echo base_url() ?>index.php/Admin/delete_guru/<?php echo $row->Id_guru ?>"><span class="btn btn-danger" style="color : white; margin-left: 10px">Hapus</span></a>
                    </td>
                    </tr>
                  <?php } ?>
                  </tbody>
