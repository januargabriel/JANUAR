              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/Admin/edit_wali/" .$id;?>" enctype="multipart/form-data">
                ...
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kode_wali" disabled="disable" value="<?php echo $kode_wali?>" style="color:red;font-family: Times New Roman">
                    </div>
                  </div>  
