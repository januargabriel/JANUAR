        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_wali" enctype="multipart/form-data"  style="background-color: DarkBlue">
                <div class="card-body row">
                <div class="satu col-sm-12"style="color:Lime;font-family: Times New Roman">
                  <div class="form-group row" >
                    <label for="input" class="col-sm-4 col-form-label">Kode Wali</label>
                    <div class="col-sm-8">
                      <input type="text" name="kode_wali" value="<?php echo $kodewali ?>" style="color:red;font-weight: bolder;" class="form-control" required='required' disabled="disable">
                      <input type="hidden" name="kode_wali" value="<?php echo $kodewali ?>">
                    </div>
                  </div>  
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Nama Wali</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama_wali" value="<?php echo set_value('nama_wali') ?>"class="form-control" required='required'>
