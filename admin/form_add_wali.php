              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_wali" enctype="multipart/form-data"  style="background-color: DarkBlue">
                ...
                <div class="satu col-sm-12"style="color:Lime;font-family: Times New Roman">
                  <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="kode" value="<?php echo $kodewali ?>" style="color:red;font-weight: bolder;" class="form-control" required='required' disabled="disable">
                      <input type="hidden" name="kode" value="<?php echo $kodewali ?>">
                    </div>
                  </div>  
                  <div class="form-group row">
