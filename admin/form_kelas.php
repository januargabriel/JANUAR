  ...
  <div class="content-wrapper" style="background-color: LightSteelBlue">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: Times New Roman;text-align: center;padding-left: 120px">Manajemen Kelas</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
            ...
            <div class="card" style="background-color: powderblue">
              <div class="card-header" style="background-color: skyblue">
                <a href="<?php echo site_url('Admin/add_kls');?>"><span class="btn btn-primary">
              ...
              <div class="card-body" style="background-color: lightblue">
                <table id="example1" class="table table-bordered table-striped" border="2px black solid" style="color: black">
                 ...
                 <tr>
                  ...
                  <tbody  style="background-color:  DarkTurquoise">
                    ...
                    <td style="background-color:  darkturqouise; ">
                      <a href="<?php echo base_url() ?>index.php/Admin/edit_kelas/<?php echo $row->id_kelas ?>"><span class="btn btn-primary" style="margin-left: 10px">&nbsp;Edit</span></a>
                       <a href="<?php echo base_url() ?>index.php/Admin/delete_kls/<?php echo $row->id_kelas?>"><span class="btn btn-danger" style="color : white; margin-left: 10 px">Hapus</span></a>
                    </td>
                  </tr>
                <?php }?>
                  </tbody>
