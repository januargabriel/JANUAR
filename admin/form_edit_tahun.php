...
if($this->input->post('is_submitted')){
  $kode_thn  =set_value('kode_thn');
  $thn_ajaran=set_value('thn_ajaran');
} else {
   $kode_thn  =$as->kode_thn;
   $thn_ajaran=$as->thn_ajaran;
}
 ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/Admin/edit_thn/" .$id;?>" enctype="multipart/form-data">
                <div class="card-body row">
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    <label for="Kode" class="col-sm-4 col-form-label">Kode</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" disabled="disable" name="kode_thn" value="<?php echo $kode_thn?>">
                    </div>
                  </div>  
                  ...
                  <div class="form-group row";>
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="thn_ajaran" value="<?php echo $thn_ajaran?>">
                    </div>
                  </div>
