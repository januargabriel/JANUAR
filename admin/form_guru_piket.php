  ...
  <div class="content-wrapper" style="background-color: LightSteelBlue">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: Times New Roman;text-align: center;padding-left: 1px">Manajemen Guru Piket</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo site_url('Page/index');?>">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?php echo site_url('Login/logout');?>"> Log Out</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
            ...
            <div class="card" style="background-color: powderblue">
              <div class="card-header" style="background-color: skyblue">
                <a href="<?php echo site_url('Admin/add_guru_piket');?>"><span class="btn btn-primary">
              ...
              <div class="card-body" style="background-color: DarkTurquoise">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                     ...
                     <?php
                    $no=1;
                    $sql="select * from data_piket";
                    $dts=$this->db->query($sql);
                    foreach ($dts->result() as $row) { 
                     ?>
                    <tr style="text-align: center;">
                    <td><?php  echo $no++; ?></td>
                    <td><?php  echo $row->kode_piket;?></td>
                    <td><?php  echo $row->guru_piket;?></td>
                    <td><?php  echo $row->password;?></td>
                    <td><?php  echo $row->id_user;?></td>
                    <td style="background-color: DarkTurquoise ; ">
                      <a href="<?php echo base_url() ?>index.php/Admin/edit_piket/<?php echo $row->kode_piket ?>"><span class="btn btn-primary" style="margin-left: 10px">&nbsp;Edit</span></a>
                       <a href="<?php echo base_url() ?>index.php/Admin/delete_piket/<?php echo $row->kode_piket?>"><span class="btn btn-danger" style="color : white; margin-left: 10 px">Hapus</span></a>
                    </td>
                  </tr>
                <?php }?>
                  </tbody>
