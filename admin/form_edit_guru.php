              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/Admin/edit_guru/" .$id;?>" enctype="multipart/form-data">
                ...
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kode_guru" disabled="disable" value="<?php echo $kode_guru?>" style="color:red;font-family: Times New Roman">
                    </div>
                  </div>  
                  <div class="form-group row";>
                    <label for="tahun" class="col-sm-4 col-form-label">Nama Guru</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama_guru" value="<?php echo $nama_guru?>">
                    </div>
                  </div>
                  <div class="form-group row";>
                    <label for="tahun" class="col-sm-4 col-form-label">Username</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label for="Pelajaran" class="col-sm-4 col-form-label">Mapel</label>
                     <div class="col-sm-8">
                       <select id="mapel" name="nama_mapel" class="form-control">
                        <option><?php echo $nama_mapel?></option>
                        <?php
