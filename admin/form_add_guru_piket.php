        ...
        <div class="row">
          <div class="col-md-6" style="margin: auto;width: 200%">
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_guru_piket" enctype="multipart/form-data">
                <?php
                mysqli_connect('localhost','root','','perkembangan2'); 
                 ?>
                ...
                <div class="satu col-sm-12">
                  ...
                  <div class="form-group row";>
                    <label for="input" class="col-sm-4 col-form-label">Guru Piket</label>
                    <div class="col-sm-8">
                      <input type="text" name="guru_piket" class="form-control" required='required' value="<?php echo set_value('guru_piket')?>">
                    </div>
                  </div>
                  <div class="form-group row";>
                    <label for="input" class="col-sm-4 col-form-label">Password</label>
                    <div class="col-sm-8">
                      <input type="text" name="password" class="form-control" required='required' value="<?php echo set_value('password')?>">
                    </div>
                  </div><!-- 
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Status</label>
                    <div class="col-sm-8" class="form-control">
                      <input type="text" name="level" value="<?php echo $level; ?>" style="color:red" class="form-control" required='required' disabled="disable">
                        <?php
                        $query = mysqli_query("SELECT * FROM user ORDER BY user.level");
