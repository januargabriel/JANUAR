  ...
  <div class="content-wrapper" style="background-color: LightSteelBlue">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family: Times New Roman;text-align: center;padding-left: 120px">Manajemen Jurusan</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
            ...
            <div class="card" style="background-color: powderblue">
              <div class="card-header" style="background-color: skyblue">
                <a href="<?php echo site_url('Admin/add_jurusan');?>"><span class="btn btn-primary">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <thead style="text-align: center;background-color: blue;color: white;  mediumblue">
                 <tr>
                  ...
                  <tbody style="background-color: DarkTurquoise">
                    ...
                    <td style="background-color:  DarkTurquoise; ">
                      <a href="<?php echo base_url() ?>index.php/Admin/edit_jurusan/<?php echo $row->Id_jurusan ?>"><span class="btn btn-primary" style="margin-left: 10px">&nbsp;Edit</span></a>
                       <a href="<?php echo base_url() ?>index.php/Admin/delete_jurusan/<?php echo $row->Id_jurusan?>"><span class="btn btn-danger" style="color : white; margin-left: 10 px">Hapus</span></a>
                    </td>
                  </tr>
                <?php }?>
                  </tbody>
...
<script src="<?= 'http://file.smkbatikpwrj.sch.id/assets/lugins/datatables-responsive/js/responsive.bootstrap4.min.js'?>"></script>
