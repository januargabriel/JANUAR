...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('asset/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback');?>">  <link rel="stylesheet" href="<?= 'http://file.smkbatikpwrj.sch.id/assets/plugins/fontawesome-free/css/all.min.css');?>">
        ...
        <div class="row">
          <div class="col-md-6" style="margin: auto;width: 200%">
            <div class="card card-info">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_mpl" enctype="multipart/form-data">
                <div class="card-body row">
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Kode Mapel</label>
                    <div class="col-sm-8">
                      <input type="text" name="kode" value="<?php echo $kodempl ?>" style="color:red" class="form-control" required='required' disabled="disable">
                      <input type="hidden" name="kode" value="<?php echo $kodempl ?>">
                    </div>
                  </div>
                  <div class="form-group row";>
                    <label for="input" class="col-sm-4 col-form-label">Nama Mapel</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama_mapel" class="form-control" required='required' value="<?php echo set_value('nama_mapel')?>">
                    </div>
                  </div>
                </div>
