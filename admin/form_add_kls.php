        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin: auto;width: 200%">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/create_kls" enctype="multipart/form-data"  style="background-color: DarkBlue">
                ...
                <div class="satu col-sm-12"style="color:Lime;font-family: Times New Roman">
                  <div class="form-group row" >
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="kode_kelas" value="<?php echo $kodekls ?>" style="color:red;font-weight: bolder;" class="form-control" required='required' disabled="disable">
                      <input type="hidden" name="kode_kelas" value="<?php echo $kodekls ?>">
                    </div>
                  </div>  
                  <div class="form-group row">
                    <label for="input" class="col-sm-4 col-form-label">Kelas</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama_kelas" value="<?php echo set_value('nama_kelas') ?>"class="form-control" required='required'>
