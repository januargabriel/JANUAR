...
if($this->input->post('is_submitted')){
  $kode_piket  =set_value('kode_piket');
  $guru_piket  =set_value('guru_piket');
  $password    =set_value('password');
  $id_user     =set_value('id_user');
} else {
   $kode_piket  =$as->kode_piket;
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/Admin/edit_piket/" .$id;?>" enctype="multipart/form-data">
                ...
                <div class="satu col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kode_piket" disabled="disable" value="<?php echo $kode_piket?>" style="color:red;font-family: Times New Roman">
                    </div>
                  </div>  
